...
const GENRE_PRESETS = [
  ...
  // ── Romanian (Românesc) ────────────────────────────────────────────────────
 { label: "Manele", cat: "Romanian", prompt: "Romanian manele 2026, accordion, oriental synth, Balkan rhythm, party music, Turkish hicaz scale, Adrian Minune & Florin Salam style: strong expressive voice, passionate singing, oriental ornamentation, emotional delivery, shouts, catchy refrains, high-fidelity club master", bpm: 112, negativePrompt: "trap 808 dominance, metal distortion, EDM drop, dubstep, harsh industrial, amateur recording" },
{ label: "Manele Clasice", cat: "Romanian", prompt: "classic manele, traditional lăutărească, accordion, violin, clarinet, traditional lăutari style: natural voice, authentic singing, traditional phrasing, vibrato, virtuoso violin accompaniment, organic high-fidelity mix", bpm: 100, negativePrompt: "electronic synth lead, trap hats, EDM, autotune, modern pop production, metallic sound" },
{ label: "Manele Moderne", cat: "Romanian", prompt: "modern manele 2026, electronic synth, oriental accordion, current Balkan rhythm, Guță & Connect-R style: clear modern voice, polished production, melodic hooks, confident delivery, pop-urban influences, crisp modern club mix", bpm: 118, negativePrompt: "metal screaming, dark ambient, orchestral epic, harsh distortion, lo-fi grit" },
{ label: "Manele Etno Fusion", cat: "Romanian", prompt: "manele etno fusion 2026, oriental-folcloric modern, accordion, club beat, TikTok viral energy, Florin Salam & Subcarpați style: powerful vocals, catchy explosive chorus, lautari influences, synth, heavy bass, high-fidelity dynamic mix", bpm: 122, negativePrompt: "trap without etno, robotic autotune, metal distortion, slow melancholic doina, flat production" },
{ label: "Manele House Club", cat: "Romanian", prompt: "manele house club 2026, electronic remix, manea vocal over heavy bass drop, four-on-the-floor, Sorinel Pustiu & Vali Vijelie style: high-energy wedding after-party, catchy synth lead, non-stop festival vibe, professional club master", bpm: 128, negativePrompt: "folclor acustic lent, ballad romantică, orchestral epic, jazz smooth, lo-fi" },
{ label: "Manele Viral TikTok", cat: "Romanian", prompt: "manele viral TikTok 2026, explosive short hits, dance challenge refrains, modern manele with fast beat, Florin Salam & Misha Miller style: powerful hook-addictive vocals, glossy production, viral energy, high-impact mix", bpm: 130, negativePrompt: "balade lungi introspective, folclor tradițional pur, metal screaming, ambient drone, slow tempo" },
{ label: "Pop Dance Românesc 2026", cat: "Romanian", prompt: "pop dance românesc 2026, international radio hit, upbeat catchy synth, strong glossy vocals, Inna & Alexandra Stan style: high-end export production, viral dancefloor hook, global radio-friendly master", bpm: 124, negativePrompt: "manele oriental dominant, hard trap românesc, metal guitars, dark ambient, lo-fi" },
{ label: "Urban Pop RO Modern", cat: "Romanian", prompt: "urban pop românesc 2026, R&B trap-light fusion, emotional melodic hooks, smooth vocal with subtle auto-tune, Andra & Killa Fonic style: romantic-urban city vibe, clean modern production, catchy streaming-ready master", bpm: 105, negativePrompt: "shout manele petrecere, folclor tradițional, orchestral symphony, rage rap, aggressive distortion" },
{ label: "Trap Pop Românesc", cat: "Romanian", prompt: "trap pop românesc 2026, melodic trap with pop influences, 808 bass, catchy synth, rap-singing blend, Nane & Rava style: melodic Romanian flow, hook auto-tune, street yet radio-friendly vibe, punchy dynamic mix", bpm: 135, negativePrompt: "boom bap old school, manele accordion dominant, orchestral epic, smooth jazz, lo-fi" },
{ label: "Retro Manele Remix 90s-2000s", cat: "Romanian", prompt: "retro manele remix 2026, 90s-2000s revival, classic manele with modern production, Nicolae Guță style: nostalgic passionate vocal, updated club beat, iconic viral refrains, punchy club master", bpm: 110, negativePrompt: "trap 808 agresiv, metal distortion, EDM big room drop, lo-fi chill, thin mix" },
{ label: "Manele Drill Fusion", cat: "Romanian", prompt: "manele drill fusion 2026, sliding 808 + oriental accordion, aggressive Romanian flow over drill beat, Rares & Nane style: hard rap mix + catchy manea refrain, dark urban Romanian street vibe, crisp drill master", bpm: 142, negativePrompt: "pop glossy curat, folclor lent, orchestral strings, smooth R&B, cheerful pop" },
{ label: "Etno Electronic RO", cat: "Romanian", prompt: "etno electronic românesc 2026, folclor reinterpreted, cobză/violin over synth and modern beat, Subcarpați & Zdob și Zdub style: powerful etno vocal, hybrid dance-electronic production, alternative festival energy, spacious dynamic mix", bpm: 125, negativePrompt: "manele synth pur, trap hi-hat spam, metal screaming, cheesy pop, standard radio pop" },
{ label: "Melodic Rap Românesc", cat: "Romanian", prompt: "melodic rap românesc 2026, auto-tune melodic over trap/pop beat, emotional catchy flow, Killa Fonic & Ian style: high melodic vocal, viral streaming hooks, modern urban Romanian vibe, polished clear master", bpm: 140, negativePrompt: "raw boom bap old school, manele shouts, orchestral epic, dark ambient, aggressive industrial" },
{ label: "Manele de Dragoste", cat: "Romanian", prompt: "manele love ballads, oriental ballad, slow tempo, romantic synth, sentimental, Nicolae Guță style: warm emotional voice, slow melancholic singing, long melodic phrases, intimate high-fidelity master", bpm: 92, negativePrompt: "aggressive trap, metal, EDM drop, harsh screaming, fast dance" },
{ label: "Manele Trap", cat: "Romanian", prompt: "manele trap, 808 bass, hi-hat rolls, oriental accordion, Romanian urban, Rares & Eazy style: mixed rap and singing, Romanian trap flow, hook auto-tune, urban delivery, punchy club master", bpm: 135, negativePrompt: "orchestral symphony, smooth jazz, classical, reggae one-drop, ambient" },
{ label: "Manele de Petrecere", cat: "Romanian", prompt: "party manele, fast rhythm, accordion, wedding or club, Florin Salam style: strong projected voice, energetic singing, party shouts, festive delivery, impactful club master", bpm: 120, negativePrompt: "slow ballad, ambient drone, metal, dark trap, lo-fi" },
{ label: "Muzică Populară", cat: "Romanian", prompt: "Romanian popular music, flute, violin, accordion, traditional, Maria Tănase style: warm deep voice, traditional emotional singing, authentic phrasing, nostalgic high-fidelity master", bpm: 95, negativePrompt: "trap beats, EDM, metal, autotune, electronic drop, aggressive distortion" },
{ label: "Folclor", cat: "Romanian", prompt: "authentic Romanian folk, doina, violin, cobza, traditional, traditional taraf style: unprocessed vocal, virtuoso lăutari performance, organic natural master", bpm: 88, negativePrompt: "electronic production, trap 808, EDM, autotune, modern pop, digital effects" },
{ label: "Doină", cat: "Romanian", prompt: "Romanian doina, violin, traditional, melancholic voice, free rubato singing, ornamentation, glissando, emotional authentic master", bpm: 72, negativePrompt: "four-on-the-floor kick, trap hats, EDM, metal, upbeat dance, synthetic" },
{ label: "Muzică Lăutărească", cat: "Romanian", prompt: "Romanian lăutărească, virtuoso violin, accordion, fast rhythm, Gypsy style, traditional taraf: vocal-violin dialogue, expressive voice, fast phrasing, party energy, organic mix", bpm: 128, negativePrompt: "trap 808, dubstep, EDM drop, metal, autotune pop, slow tempo" },
{ label: "Taraf", cat: "Romanian", prompt: "Romanian taraf, lăutari orchestra, violin cobza accordion, wedding party, traditional lăutari ensemble: collective performance, voice-instrument interplay, energetic high-fidelity mix", bpm: 125, negativePrompt: "electronic bass drop, trap, EDM, metal distortion, modern synths" },
{ label: "Sârbă", cat: "Romanian", prompt: "Romanian sârbă, traditional dance, violin, accordion, fast rhythm, wedding style: rhythmic vocal, instruments for dance, shouts, festive master", bpm: 132, negativePrompt: "slow ballad, ambient, metal, trap 808, smooth jazz" },
{ label: "Hora", cat: "Romanian", prompt: "Romanian hora, circle dance, violin, accordion, traditional rhythm, folk dance style: repetitive circular vocal, catchy phrasing, organic high-fidelity master", bpm: 120, negativePrompt: "trap, dubstep, metal, EDM drop, dark ambient, aggressive" },
{ label: "Brâu", cat: "Romanian", prompt: "Romanian brâu, traditional dance, characteristic rhythm, folk ensemble: unison vocal, choir, dance rhythm, authentic acoustic master", bpm: 118, negativePrompt: "electronic drop, trap hats, metal, EDM supersaw, glossy pop" },
{ label: "Muzică de Nuntă", cat: "Romanian", prompt: "Romanian wedding music, lăutari, violin, accordion, festive, taraf style: party singing, shouts, wedding greetings, high-energy impact master", bpm: 122, negativePrompt: "metal screaming, dark ambient, EDM drop, harsh industrial, slow ballad" },
{ label: "Muzică de Restaurant", cat: "Romanian", prompt: "Romanian restaurant music, light orchestra, violin accordion, elegant atmosphere, easy listening: warm refined voice, elegant background tone, high-fidelity natural mix", bpm: 95, negativePrompt: "trap, dubstep, metal, aggressive rap, EDM, fast dance" },
{ label: "Muzică Ușoară Românească", cat: "Romanian", prompt: "Romanian easy listening, beautiful melody, 70s-90s, romanticism, Angela Similea style: warm romantic voice, melodious singing, clear phrasing, emotional high-fidelity master", bpm: 98, negativePrompt: "trap 808, metal, EDM drop, harsh screaming, dubstep" },
{ label: "Cântec Bătrânesc", cat: "Romanian", prompt: "Romanian old song, nostalgia, violin accordion, traditional ballad, Maria Lătărețu style: mature emotional voice, storytelling, nostalgic tone, sincere organic master", bpm: 82, negativePrompt: "trap beats, EDM, metal, autotune, electronic, upbeat" },
{ label: "Etno Românesc", cat: "Romanian", prompt: "Romanian etno, folk reinterpreted, traditional instruments, modern production, Subcarpați & Zdob și Zdub style: strong modern voice, alternative-etno energy, catchy refrains, dynamic master", bpm: 128, negativePrompt: "smooth jazz, orchestral waltz, trap 808 spam, glossy pop, lo-fi" },
{ label: "Pop Românesc", cat: "Romanian", prompt: "Romanian pop modern, radio Romania, Inna & Alexandra Stan style: clear radio-friendly voice, modern production, clear hooks, confident delivery, polished master", bpm: 120, negativePrompt: "metal screaming, dark trap, orchestral epic, harsh distortion, ethnic traditional" },
{ label: "Rock Românesc", cat: "Romanian", prompt: "Romanian rock, electric guitar, alternative rock, Phoenix & Iris style: strong rock voice, emotional powerful singing, alternative delivery, energetic tone, punchy rock master", bpm: 125, negativePrompt: "trap 808, reggae skank, smooth jazz, orchestral strings as lead, synthetic" },
{ label: "Hip-Hop Românesc", cat: "Romanian", prompt: "Romanian hip hop, rap, urban beat, street lyrics, BUG Mafia & Paraziții style: articulate Romanian flow, confrontational delivery, rhyme and wordplay, punchy dynamic master", bpm: 92, negativePrompt: "orchestral, EDM four-on-the-floor, smooth jazz, country, melodic pop" },
{ label: "Trap Românesc", cat: "Romanian", prompt: "Romanian trap, 808 bass, hi-hat rolls, Romanian urban, Nane & Rava style: Romanian trap flow, auto-tune melodies, street hooks, punchy club master", bpm: 138, negativePrompt: "orchestral symphony, jazz improvisation, reggae one-drop, boom bap" },
{ label: "Muzică Balcanică", cat: "Romanian", prompt: "Balkan music, energetic rhythm, accordion, trumpet, Turkish/Greek influence, Goran Bregović style: strong Balkan voice, festive singing, shouts/choirs, impactful master", bpm: 128, negativePrompt: "trap 808, dubstep, smooth jazz, dark ambient, lo-fi" },
{ label: "Muzică Orientală", cat: "Romanian", prompt: "Romanian oriental music, oriental synth, dance rhythm, Turkish influences, Adrian Minune style: warm voice, oriental ornamentation, melisma, dance atmosphere, professional master", bpm: 115, negativePrompt: "metal screaming, EDM drop, harsh industrial, dark trap, acoustic" },
{ label: "Colinde", cat: "Romanian", prompt: "Romanian carols, Christmas, choir, traditional, holiday atmosphere, carolers style: clean voice or choir, solemn warm tone, authentic organic master", bpm: 88, negativePrompt: "trap beats, EDM, metal, aggressive rap, dubstep" },
{ label: "Cântec Patriotic", cat: "Romanian", prompt: "Romanian patriotic, march, choir, orchestra, solemn, military style: martial voice, solemn unified singing, grave powerful master", bpm: 100, negativePrompt: "trap 808, EDM drop, reggae groove, autotune pop" },
{ label: "Indie / Alternativă România", cat: "Romanian", prompt: "Romanian alternative, indie, guitar, modern production, Coma style: introspective voice, alternative singing, personal delivery, clean balanced master", bpm: 108, negativePrompt: "trap hi-hat spam, EDM drop, metal screaming, cheesy pop chorus" }
 // ── House & Electronic ─────────────────────────────────────────────────────────
...
{ label: "Arabic Tarab / Classical", cat: "Oriental Traditional", prompt: "arabic tarab classical traditional, maqam improvisation emotional peak, vocal melisma long taqsim, oud qanun ney violin ensemble, Umm Kulthum Abdel Halim Hafez Fairuz Mohammad Abdel Wahab style: deep storytelling tarab ecstasy, acoustic purity, concert hall intimacy, pure emotional soul", bpm: 70, negativePrompt: "electronic synths, trap 808, autotune heavy, modern beats, drops, distortion" },
{ label: "Türk Sanat Müziği / Classical Turkish", cat: "Oriental Traditional", prompt: "türk sanat müziği classical traditional, makam-based refined composition, elegant vocal ornamentation melisma, tanbur oud kanun violin, Zeki Müren Bülent Ersoy Münir Nurettin Selçuk Müzeyyen Senar style: poetic emotional phrasing, slow rubato to rhythmic usul, sophisticated salon concert atmosphere, acoustic purity dramatic telenovela vibe", bpm: 80, negativePrompt: "electronic beats, trap 808, autotune heavy, modern pop drops, distortion" },
{ label: "Arabesk Classic Turkish", cat: "Oriental Traditional", prompt: "arabesk classic traditional turkish, emotional pain suffering lyrics, slow melancholic melodies, Orhan Gencebay Müslüm Gürses Ferdi Tayfur Ibrahim Tatlıses style: dramatic vocal cries, oud violin kanun leads, acoustic ensemble, heartbroken telenovela soundtrack vibe, raw emotional depth", bpm: 85, negativePrompt: "upbeat dance rhythms, synth heavy, trap hi-hats, hyperpop glitch, bright major key" },
{ label: "Fasıl Ensemble Turkish", cat: "Oriental Traditional", prompt: "fasıl traditional ensemble turkish, suite of makam pieces, instrumental prelude peşrev saz semai, vocal şarkı bölümü, taksim improvisation, classic meyhane style: lively to emotional flow, clarinet kanun violin accordion, festive yet dramatic party telenovela atmosphere, acoustic group performance", bpm: 90, negativePrompt: "modern electronic fusion, trap 808 dominance, deep house pads, orchestral epic without makam, slow ambient" },
{ label: "Anadolu Halk Müziği Turkish", cat: "Oriental Traditional", prompt: "anadolu halk müziği traditional folk turkish, bağlama saz lead, aşık storytelling songs, uzun hava kırık hava, Aşık Veysel Neşet Ertaş Selda Bağcan style: rural emotional narratives, microtonal melodies, acoustic simplicity, telenovela village/drama scenes vibe", bpm: 95, negativePrompt: "arabesk heavy drama, modern pop polish, electronic synths, trap beats, urban mahraganat" },
{ label: "Raqs Sharqi Classical", cat: "Oriental Traditional", prompt: "raqs sharqi belly dance classical traditional, egyptian oriental dance music, baladi saidi rhythms, darbuka riq sagat heavy, Hossam Ramzy Mohamed Abdel Wahab style: seductive expressive percussion, melodic violin ney qanun, live show wedding energy", bpm: 110, negativePrompt: "slow ambient, trap 808, modern deep house, orchestral dominant, chill lounge" },
{ label: "Levantine Dabke Traditional", cat: "Oriental Traditional", prompt: "levantine dabke traditional, palestinian lebanese syrian jordanian group dance, mijwiz accordion violin percussion, folk style: powerful communal chants, celebratory wedding energy, high-tempo drive acoustic", bpm: 120, negativePrompt: "deep house groove, trap triplet hats, neurofunk, hyperpop, slow ballad" },
{ label: "Gnawa Traditional Spiritual", cat: "Oriental Traditional", prompt: "gnawa moroccan traditional spiritual, sufi trance rhythms, guembri sintir qraqeb hypnotic, call-response chants, Mahmoud Guinea Maleem Hamid style: deep ritualistic trance, healing energy, acoustic roots mysticism, ceremonial group", bpm: 90, negativePrompt: "electronic fusion heavy, trap beats, autotune, orchestral epic, bright pop" },
...
{ label: "Oriental Deep House", cat: "Oriental Modern / Fusion", prompt: "oriental deep house 2026, hypnotic desert vibes, ethnic maqam tribal percussion, deep sub bass groove, Cafe De Anatolia Hypnotic Desert MT MUSIC style: atmospheric pads, darbuka congas, warm vocal chants, late-night lounge ritual energy", bpm: 120, negativePrompt: "aggressive trap rage, big room drops, phonk distortion, pure classical acoustic, metal guitars" },
{ label: "Turkish Oriental Deep House", cat: "Oriental Modern / Fusion", prompt: "turkish oriental deep house 2026, hypnotic makam synths, ethnic percussion darbuka ney fusion, deep groove sub bass, Cafe De Anatolia turkish mix influence style: atmospheric pads, warm vocal chops, late-night lounge/club ritual, diziler romantic scene energy", bpm: 122, negativePrompt: "aggressive trap rage, big room drops, phonk cowbell heavy, pure acoustic tarab, harsh industrial" },
{ label: "Modern Arabesk / Arabesk Pop Turkish", cat: "Oriental Modern / Fusion", prompt: "modern arabesk pop turkish 2026, emotional dramatic lyrics, arabesk roots meets glossy production, auto-tune subtle, Ibrahim Tatlıses Orhan Gencebay legacy + Serdar Ortaç Mabel Matiz style: melancholic hooks, violin oud synth fusion, telenovela heartbreak OST vibe, radio/streaming crossover", bpm: 90, negativePrompt: "pure classical makam purity, trap heavy 808, deep house hypnotic, hyperpop chaos, metal distortion" },
{ label: "Turkish Pop Oriental Fusion", cat: "Oriental Modern / Fusion", prompt: "turkish pop oriental fusion 2026, catchy radio hooks, makam melodies in modern pop, synth violin kanun hybrid, Tarkan Sezen Aksu Hande Yener Mabel Matiz style: emotional upbeat/dramatic, glossy production, telenovela soundtrack viral hits, streaming shine", bpm: 100, negativePrompt: "dark arabesk melancholy heavy, trap 808 dominance, deep neurofunk, lo-fi chill, orchestral epic" },
{ label: "Turkish Trap / Urban Oriental", cat: "Oriental Modern / Fusion", prompt: "turkish trap urban oriental 2026, 808 bass meets makam scales, darbuka hybrid percussion, auto-tune melodic flows, Ezhel Ben Fero Lvbel C5 style: street swagger dark atmosphere, telenovela intense drama scenes, viral club/TikTok weapon", bpm: 140, negativePrompt: "clean boom bap, smooth jazz piano, liquid dnb breaks, bright pop chorus, classical purity" },
{ label: "Diziler OST Oriental Dramatic", cat: "Oriental Modern / Fusion", prompt: "turkish diziler OST oriental dramatic 2026, emotional soundtrack melodies, violin oud kanun synth fusion, slow build to intense chorus, telenovela style: heartbreak longing passion, cinematic strings pads, modern turkish pop/oriental drama vibe", bpm: 85, negativePrompt: "upbeat dance energy, trap hi-hat spam, hyperpop maximalism, pure acoustic fasıl, chill lounge" },
{ label: "Mahraganat / Electro Shaabi", cat: "Oriental Modern / Fusion", prompt: "mahraganat electro shaabi 2026, egyptian street festival music, auto-tune heavy rap vocals, synth tabla hybrid beats, Hassan Shakosh Omar Kamal Wegz Eslam Kabonga style: chaotic high-energy anthems, viral TikTok street vibe, raw urban youth rebellion", bpm: 105, negativePrompt: "pure classical tarab, orchestral purity, slow rubato, chill lounge, traditional acoustic only" },
{ label: "Khaleeji Pop Modern", cat: "Oriental Modern / Fusion", prompt: "khaleeji pop modern 2026, gulf glossy pop fusion, catchy oriental synths, traditional percussion light, Hussain Al Jassmi Rashed Al Majed Nawal El Kuwaiti style: radio-friendly shine, emotional/upbeat hooks, multilingual, streaming viral crossover", bpm: 100, negativePrompt: "dark mahraganat street, trap heavy, deep neurofunk, phonk cowbell, metal distortion" },
  ...
  { label: "Reggaeton", cat: "Latin Pop / Reggaeton", prompt: "reggaeton 2026, classic dembow rhythm revival, heavy perreo bass, catchy Spanish melodic hooks, sensual urban party energy, Karol G Feid Bad Bunny Ryan Castro Blessd style: auto-tune flows, infectious chants, street-to-radio crossover, roots 2011-2013 structure meets modern polish, viral TikTok dancefloor weapon", bpm: 95, negativePrompt: "four-on-the-floor house, trap 808 slides dominant, orchestral epic, boom bap raw, hyperpop glitch" },
  { label: "Latin Pop Crossover", cat: "Latin Pop / Reggaeton", prompt: "latin pop 2026, glossy radio-friendly hits, upbeat tropical beats, powerful bilingual vocals, Karol G Shakira Rauw Alejandro Kenia Os Jombriel style: emotional or party hooks, polished production, global streaming shine, reggaeton-pop fusion light, major key uplift", bpm: 100, negativePrompt: "dark phonk cowbell, drill aggression, lo-fi hiss, heavy neurofunk bass, metal distortion" },
  { label: "Reggaeton Trap / Urbano", cat: "Latin Pop / Reggaeton", prompt: "reggaeton trap urbano 2026, dembow meets heavy 808s, melodic auto-tune rap-singing, street swagger energy, Feid Anuel AA Ozuna DFZM Clarent style: catchy hooks over trap-influenced bass, perreo-trap hybrid, Latin urban dark vibe, viral club weapon", bpm: 140, negativePrompt: "pure orchestral pads, smooth jazz chords, liquid dnb breaks, aggressive rage screaming, chill ambient drone" },
  { label: "Afro-Latin Dembow Fusion", cat: "Latin Pop / Reggaeton", prompt: "afro-latin dembow 2026, reggaeton meets afrobeats percussion, groovy log drum hybrid, soulful chants, Jombriel Kapo Hamilton Beele style: danceable global fusion, rhythmic layers, uplifting yet urban, honoring African diaspora roots in Colombia/Pacific/Caribbean", bpm: 105, negativePrompt: "minimal house groove, trap hi-hat spam, orchestral symphony, pure phonk cowbell" },
...
{ label: "Drum & Bass", cat: "Drum & Bass / Jungle", prompt: "drum and bass 2026, fast rolling 170-175 bpm breaks, heavy sub bass, high-energy festival anthems, Metrik Sub Focus Grafix Andromedik Kanine Dimension style: pop-leaning melodic hooks, crossover vocals, dancefloor drops, global mainstream crossover energy, Gen Z high-tempo vibe", bpm: 174, negativePrompt: "slow trap groove, orchestral pads dominant, phonk cowbell heavy, reggaeton dembow, chill ambient drone" },
{ label: "Liquid DnB", cat: "Drum & Bass / Jungle", prompt: "liquid drum and bass 2026, soulful melodic rolling breaks, atmospheric pads, warm jazzy chords, mature understated vocals, High Contrast Netsky Pola & Bryson Calibre Monrroe style: emotional immersive journey, evolved rollers, smooth driving energy, late-night headphone/festival feel, less overpowering pop toplines", bpm: 172, negativePrompt: "aggressive neuro reese wobble, heavy metal guitars, trap hi-hat spam, dark phonk distortion, big room supersaw drops" },
{ label: "Neurofunk", cat: "Drum & Bass / Jungle", prompt: "neurofunk 2026, dark rolling neuro basslines, razor-sharp techy leads, dystopian futuristic sound design, Black Sun Empire Noisia TR Tactics Teddy Killerz Mefjus A.M.C style: relentless aggression, industrial grit, new-school neuro elements, warehouse/headphone intensity, cybernetic heavy pressure", bpm: 174, negativePrompt: "uplifting liquid pads, orchestral epic melodies, bright pop hooks, chill phonk cowbell, slow reggaeton groove" },
{ label: "Modern Jungle", cat: "Drum & Bass / Jungle", prompt: "modern jungle 2026, breakbeat revival roots, gritty raw energy, atmospheric deep cuts, Tim Reaper illesta Peshay Nookie influence style: old-school jungle grooves meets fresh production, chopped samples, club/underground weapon, high-tempo bouncy vibe", bpm: 170, negativePrompt: "clean melodic trap, orchestral cinematic, smooth liquid soulful, hyperpop glitch, big room festival drops" },
{ label: "Jump Up DnB", cat: "Drum & Bass / Jungle", prompt: "jump up drum and bass 2026, heavy ragga-influenced basslines, energetic festival rollers, filthy dancefloor bangers, T-Lex Kanine Nu Elementz style: high-octane aggression, vocal chops, crowd hype energy, underground to mainstage crossover", bpm: 175, negativePrompt: "chill atmospheric pads, orchestral strings, slow melodic liquid, phonk distortion heavy, ambient drone" },
{ label: "Melodic Neurofunk", cat: "Drum & Bass / Jungle", prompt: "melodic neurofunk 2026, dark neuro bass meets atmospheric melodic layers, cinematic rainy night vibes, hybrid neuro-liquid fusion, Bruffness MUZZ Sub Focus style: haunting ethereal pads, intricate stereoscopic drums, deep immersive energy, late-night drive/focus soundtrack", bpm: 172, negativePrompt: "pure aggressive reese spam, trap 808 dominance, bright uplifting chords, chill lo-fi, orchestral symphony" },
{ label: "Techstep / Darkstep", cat: "Drum & Bass / Jungle", prompt: "techstep darkstep 2026, ultra-technical dark neurofunk, industrial dystopian textures, heavy reese + razor leads, Ed Rush Magnetude Zardonic style: futuristic aggression, minimal growls/vocals, relentless pressure, warehouse dark energy", bpm: 175, negativePrompt: "soulful liquid melodies, pop crossover hooks, orchestral epic, bright major key, reggae skank" },
{ label: "Hybrid Jungle / DnB", cat: "Drum & Bass / Jungle", prompt: "hybrid jungle dnb 2026, jungle roots meets modern dnb experimentation, breakbeat + neuro/liquid fusion, global underground revival, Tim Reaper + new-school influence style: raw grimy grooves, evolved atmospheric elements, club-ready high-energy, boundary-pushing future classics", bpm: 173, negativePrompt: "clean polished mix, trap hi-hat triplets, orchestral pads without breaks, hyperpop maximalism, slow ambient" },
