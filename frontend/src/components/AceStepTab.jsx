...
// Stiluri autentice tradiționale arabe / orientale (maqam, tarab, folk regional, dans clasic) – live, acustic, nunți, concerte, spiritual – încă foarte vii în 2026
...
{ label: "Iraqi Maqam Traditional", cat: "Oriental Traditional", prompt: "iraqi maqam traditional, baghdad classical suite, intricate vocal-instrumental, oud santur joza, Youssou Nowruz legacy style: poetic microtonal depth, slow rubato to rhythmic usul, acoustic ensemble warmth, historical elegance", bpm: 75, negativePrompt: "dance club rhythms, modern pop, trap hi-hats, electronic fusion, bright major key" },
{ label: "Türk Sanat Müziği / Classical", cat: "Turkish Traditional", prompt: "türk sanat müziği classical traditional, makam-based refined composition, elegant vocal ornamentation melisma, tanbur oud kanun violin, Zeki Müren Bülent Ersoy Münir Nurettin Selçuk Müzeyyen Senar style: poetic emotional phrasing, slow rubato to rhythmic usul, sophisticated salon concert atmosphere, acoustic purity dramatic telenovela vibe", bpm: 80, negativePrompt: "electronic beats, trap 808, autotune heavy, modern pop drops, distortion" },
{ label: "Arabesk Classic", cat: "Turkish Traditional", prompt: "arabesk classic traditional, emotional pain suffering lyrics, slow melancholic melodies, Orhan Gencebay Müslüm Gürses Ferdi Tayfur Ibrahim Tatlıses style: dramatic vocal cries, oud violin kanun leads, acoustic ensemble, heartbroken telenovela soundtrack vibe, raw emotional depth", bpm: 85, negativePrompt: "upbeat dance rhythms, synth heavy, trap hi-hats, hyperpop glitch, bright major key" },
{ label: "Fasıl Ensemble", cat: "Turkish Traditional", prompt: "fasıl traditional ensemble, suite of makam pieces, instrumental prelude peşrev saz semai, vocal şarkı bölümü, taksim improvisation, classic meyhane style: lively to emotional flow, clarinet kanun violin accordion, festive yet dramatic party telenovela atmosphere, acoustic group performance", bpm: 90, negativePrompt: "modern electronic fusion, trap 808 dominance, deep house pads, orchestral epic without makam, slow ambient" },
{ label: "Anadolu Halk Müziği", cat: "Turkish Traditional", prompt: "anadolu halk müziği traditional folk, bağlama saz lead, aşık storytelling songs, uzun hava kırık hava, Aşık Veysel Neşet Ertaş Selda Bağcan style: rural emotional narratives, microtonal melodies, acoustic simplicity, telenovela village/drama scenes vibe", bpm: 95, negativePrompt: "arabesk heavy drama, modern pop polish, electronic synths, trap beats, urban mahraganat" },
...
{ label: "Khaleeji Traditional Sawt", cat: "Oriental Traditional", prompt: "khaleeji traditional sawt, gulf folk rhythms, oud rababa percussion heavy, nabati poetry singing, ardha dance influence style: rhythmic handclaps, group chants, desert nomadic festive energy, acoustic warmth", bpm: 95, negativePrompt: "electronic drops, autotune heavy, trap 808, orchestral epic, chill ambient" },
...
{ label: "Andalusi / Gharnati Classical", cat: "Oriental Traditional", prompt: "andalusi gharnati classical traditional, maghreb andalusian suite, rabab oud qanun percussion, Algerian Moroccan Tunisian style: poetic verses, refined orchestration, historical elegance, live ensemble", bpm: 85, negativePrompt: "contemporary synths, mahraganat chaos, trap 808, hyperpop, slow ambient drone" },
{ label: "Shaabi Egyptian Traditional", cat: "Oriental Traditional", prompt: "shaabi egyptian traditional folk, working-class roots, upbeat mawwal rhythms, accordion violin tabla, Ahmed Adaweya Hassan El Asmar style: street storytelling, raw emotional vocals, wedding party acoustic energy", bpm: 105, negativePrompt: "mahraganat electro heavy, trap 808 dominance, deep house pads, orchestral epic, modern polish" },

// ── Oriental Modern / Fusion ───────────────────────────────────────────────────
// Variante contemporane 2026: oriental deep house viral, mahraganat, khaleeji pop, arabic mainstream, oriental trap/reggaeton, lounge modern – club, TikTok, streaming, crossover
...
{ label: "Arabic Pop Mainstream 2026", cat: "Oriental Modern / Fusion", prompt: "arabic pop mainstream 2026, glossy radio hits, upbeat modern production, powerful vocal runs maqam touches, Amr Diab Tamer Hosny Nancy Ajram Elissa style: catchy emotional/dance hooks, high-end polish, global charts dominance", bpm: 95, negativePrompt: "raw mahraganat chaos, traditional tarab improvisation, trap heavy, oriental deep house hypnotic" },
{ label: "Oriental Trap / Balkan Trap", cat: "Oriental Modern / Fusion", prompt: "oriental trap 2026, turkish arabic balkan trap fusion, heavy 808 bass, oriental scales synths, darbuka hybrid, turkish trap type beat style: auto-tune melodic flows, dark atmospheric pads, street urban energy with middle eastern ornamentation, viral underground", bpm: 140, negativePrompt: "clean boom bap drums, orchestral strings lead, smooth jazz piano, liquid dnb breaks, bright pop chorus" },
{ label: "Oriental Reggaeton Fusion", cat: "Oriental Modern / Fusion", prompt: "oriental reggaeton 2026, dembow rhythm meets arabic turkish melodies, oriental dancehall fusion, sensual perreo energy, arabic type beat turkish oriental dancehall style: catchy hooks with maqam scales, heavy bass exotic percussion, club TikTok viral", bpm: 95, negativePrompt: "four-on-the-floor house kick, neurofunk razor leads, trap hi-hat spam, orchestral epic, chill ambient drone" },
{ label: "Oriental Chill Lounge Modern", cat: "Oriental Modern / Fusion", prompt: "oriental chill lounge 2026, balkan arabic oriental background modern, relaxing ethnic beats, hookah cafe vibes, BuJaa BEATS oriental chillout style: soft darbuka ney flute, atmospheric pads, downtempo groove, premium relaxing atmosphere", bpm: 90, negativePrompt: "high-energy festival drops, trap 808 dominance, hyperpop maximalism, fast jungle breaks, harsh distortion" },
{ label: "Modern Arabesk / Arabesk Pop", cat: "Turkish Modern / Fusion", prompt: "modern arabesk pop 2026, emotional dramatic lyrics, arabesk roots meets glossy production, auto-tune subtle, Ibrahim Tatlıses Orhan Gencebay legacy + Serdar Ortaç Mabel Matiz style: melancholic hooks, violin oud synth fusion, telenovela heartbreak OST vibe, radio/streaming crossover", bpm: 90, negativePrompt: "pure classical makam purity, trap heavy 808, deep house hypnotic, hyperpop chaos, metal distortion" },
{ label: "Turkish Oriental Deep House", cat: "Turkish Modern / Fusion", prompt: "turkish oriental deep house 2026, hypnotic makam synths, ethnic percussion darbuka ney fusion, deep groove sub bass, Cafe De Anatolia turkish mix influence style: atmospheric pads, warm vocal chops, late-night lounge/club ritual, diziler romantic scene energy", bpm: 122, negativePrompt: "aggressive trap rage, big room drops, phonk cowbell heavy, pure acoustic tarab, harsh industrial" },
{ label: "Turkish Pop Oriental Fusion", cat: "Turkish Modern / Fusion", prompt: "turkish pop oriental fusion 2026, catchy radio hooks, makam melodies in modern pop, synth violin kanun hybrid, Tarkan Sezen Aksu Hande Yener Mabel Matiz style: emotional upbeat/dramatic, glossy production, telenovela soundtrack viral hits, streaming shine", bpm: 100, negativePrompt: "dark arabesk melancholy heavy, trap 808 dominance, deep neurofunk, lo-fi chill, orchestral epic" },
{ label: "Turkish Trap / Urban Oriental", cat: "Turkish Modern / Fusion", prompt: "turkish trap urban oriental 2026, 808 bass meets makam scales, darbuka hybrid percussion, auto-tune melodic flows, Ezhel Ben Fero Lvbel C5 style: street swagger dark atmosphere, telenovela intense drama scenes, viral club/TikTok weapon", bpm: 140, negativePrompt: "clean boom bap, smooth jazz piano, liquid dnb breaks, bright pop chorus, classical purity" },
{ label: "Diziler OST Oriental Dramatic", cat: "Turkish Modern / Fusion", prompt: "turkish diziler OST oriental dramatic 2026, emotional soundtrack melodies, violin oud kanun synth fusion, slow build to intense chorus, telenovela style: heartbreak longing passion, cinematic strings pads, modern turkish pop/oriental drama vibe", bpm: 85, negativePrompt: "upbeat dance energy, trap hi-hat spam, hyperpop maximalism, pure acoustic fasıl, chill lounge" },
...
const DEFAULT_CAT_META = {
  ...
  "Afrobeats / Afropop": {
    ...
    icon: "🌍",
    color: "#ffd166",
    description: "Afrobeats, amapiano, afropop",
    order: 6,
  },
  "Oriental Traditional": {
