...
{ label: "Trap Pop Românesc", cat: "Romanian", prompt: "trap pop românesc 2026, melodic trap cu influențe pop, 808 bass + synth catchy, rap-singing blend, Nane & Rava style: flow românesc melodic, auto-tune pe hook, vibe stradal dar radio-friendly", bpm: 135, negativePrompt: "boom bap old school, manele accordion dominant, orchestral epic, smooth jazz" },
{ label: "Retro Manele Remix 90s-2000s", cat: "Romanian", prompt: "retro manele remix 2026, 90s-2000s revival, classic manele cu producție modernă, Nicolae Guță & Adrian Copilul Minune style: voce nostalgică pasională, beat updatat club, refrene iconice reluate viral, punchy club master", bpm: 110, negativePrompt: "trap 808 agresiv, metal distortion, EDM big room drop, lo-fi chill" },
{ label: "Manele Drill Fusion", cat: "Romanian", prompt: "manele drill fusion 2026, sliding 808 + acordeon oriental, flow agresiv românesc peste drill beat, Rares & Nane style: mix rap dur + refren manea catchy, vibe stradal urban românesc dark, crisp drill master", bpm: 142, negativePrompt: "pop glossy curat, folclor lent, orchestral strings, smooth R&B" },
{ label: "Etno Electronic RO", cat: "Romanian", prompt: "etno electronic românesc 2026, folclor reinterpretat electronic, cobză/violin peste synth și beat modern, Subcarpați & Zdob și Zdub style: voce puternică etno, producție hybrid dance-electronic, energie alternativă festival, spacious dynamic mix", bpm: 125, negativePrompt: "manele synth pur, trap hi-hat spam, metal screaming, cheesy pop" },
{ label: "Melodic Rap Românesc", cat: "Romanian", prompt: "melodic rap românesc 2026, auto-tune melodic peste trap/pop beat, flow emoțional catchy, Killa Fonic & Ian style: voce înaltă melodică, refrene virale streaming, vibe urban tânăr românesc, polished clear master", bpm: 140, negativePrompt: "raw boom bap old school, manele shouts, orchestral epic, dark ambient" },
{ label: "Bătătură", cat: "Romanian", prompt: "Romanian bătătură, traditional dance, strong rhythm, folk, popular music style: strong rhythmic voice, singing for bătătură dance, energetic delivery, organic natural master", bpm: 130, negativePrompt: "trap 808, dubstep, smooth jazz, orchestral waltz" },
{ label: "Muzică de Nuntă", cat: "Romanian", prompt: "Romanian wedding music, lăutari, violin, accordion, party, dance, good vibes, taraf style: voice and orchestra for wedding, festive singing, shouts and greetings, party energy, high-energy impact master", bpm: 122, negativePrompt: "metal screaming, dark ambient, EDM drop, harsh industrial" },
{ label: "Muzică de Restaurant", cat: "Romanian", prompt: "Romanian restaurant music, light orchestra, violin accordion, well-known melodies, elegant atmosphere, easy listening style: warm pleasant voice, refined singing, elegant background tone, high-fidelity natural mix", bpm: 95, negativePrompt: "trap, dubstep, metal, aggressive rap, EDM" },
{ label: "Muzică Ușoară Românească", cat: "Romanian", prompt: "Romanian easy listening, beautiful melody, 70s-90s, romanticism, Angela Similea & Dan Spătaru style: warm romantic voice, melodious singing, clear phrasing, emotion and tenderness, high-fidelity master", bpm: 98, negativePrompt: "trap 808, metal, EDM drop, harsh screaming, dubstep" },
{ label: "Cântec Bătrânesc", cat: "Romanian", prompt: "Romanian old song, old Romanian music, nostalgia, violin accordion, traditional ballad, Maria Lătărețu style: mature emotional voice, storytelling singing, nostalgic tone, simple sincere delivery, organic master", bpm: 82, negativePrompt: "trap beats, EDM, metal, autotune, electronic" },
{ label: "Etno Românesc", cat: "Romanian", prompt: "Romanian etno, folk reinterpreted, traditional instruments with modern production, etno fusion, Subcarpați & Zdob și Zdub style: strong modern voice, rock-etno energy singing, catchy refrains, alternative delivery, dynamic master", bpm: 128, negativePrompt: "smooth jazz, orchestral waltz, trap 808 spam, glossy pop" },
{ label: "Pop Românesc", cat: "Romanian", prompt: "Romanian pop modern, contemporary production, catchy melody, radio Romania, Inna & Alexandra Stan style: clear radio-friendly voice, modern production singing, clear hooks, confident catchy delivery, polished master", bpm: 120, negativePrompt: "metal screaming, dark trap, orchestral epic, harsh distortion" },
{ label: "Rock Românesc", cat: "Romanian", prompt: "Romanian rock, electric guitar, Romanian lyrics, alternative rock, Phoenix & Iris style: strong rock voice, emotional powerful singing, alternative delivery, introspective or energetic tone, punchy rock master", bpm: 125, negativePrompt: "trap 808, reggae skank, smooth jazz, orchestral strings as lead" },
{ label: "Hip-Hop Românesc", cat: "Romanian", prompt: "Romanian hip hop, rap in Romanian, urban beat, street lyrics, BUG Mafia & Paraziții style: clear flow in Romanian, confrontational or lyrical delivery, rhyme and wordplay, projected voice, punchy dynamic master", bpm: 92, negativePrompt: "orchestral, EDM four-on-the-floor, smooth jazz, country" },
{ label: "Trap Românesc", cat: "Romanian", prompt: "Romanian trap, 808 bass, hi-hat rolls, rap in Romanian, Romanian urban, Nane & Rava style: Romanian trap flow, auto-tune on melodies, cold or melodic delivery, hooks in Romanian, punchy club master", bpm: 138, negativePrompt: "orchestral symphony, jazz improvisation, reggae one-drop" },
{ label: "Muzică Balcanică", cat: "Romanian", prompt: "Balkan music, energetic rhythm, accordion, trumpet, Turkish and Greek influences, Balkan party, Goran Bregović style: strong Balkan voice, energetic festive singing, shouts and choirs, party delivery, impactful master", bpm: 128, negativePrompt: "trap 808, dubstep, smooth jazz, dark ambient" },
{ label: "Muzică Orientală", cat: "Romanian", prompt: "Romanian oriental music, oriental synth, dance rhythm, Turkish influences, Adrian Minune style: warm voice with ornamentation, expressive oriental singing, melisma and trills, dance atmosphere, professional master", bpm: 115, negativePrompt: "metal screaming, EDM drop, harsh industrial, dark trap" },
{ label: "Colinde", cat: "Romanian", prompt: "Romanian carols, Christmas music, choir, tradition, holiday atmosphere, carolers style: clean voice or choir, traditional carol singing, warm solemn tone, authentic organic master", bpm: 88, negativePrompt: "trap beats, EDM, metal, aggressive rap, dubstep" },
{ label: "Cântec Patriotic", cat: "Romanian", prompt: "Romanian patriotic song, march, choir, orchestra, solemn, military fanfare style: choir or strong martial voice, solemn unified singing, grave delivery, powerful master", bpm: 100, negativePrompt: "trap 808, EDM drop, reggae groove, autotune pop" },
{ label: "Indie / Alternativă România", cat: "Romanian", prompt: "Romanian alternative music, Romanian indie, guitar, modern production, Romanian lyrics, Coma & The Mono style: introspective or experimental voice, alternative singing, personal delivery, contemplative tone, clean balanced master", bpm: 108, negativePrompt: "trap hi-hat spam, EDM drop, metal screaming, cheesy pop chorus" },
 // ── House & Electronic ─────────────────────────────────────────────────────────
