...
- If NO artist mentioned by user → Use YOUR KNOWLEDGE to suggest 1-2 relevant artists for that specific genre/subgenre/culture
  * Match the artist's style to the genre (e.g., afro house → African house artists, turkish oriental → Turkish artists, manele → Romanian manele artists, trap → trap artists, etc.)
  * Choose artists that are culturally appropriate for the genre
- Format: "ArtistName style" or "ArtistName type beat"
- CRITICAL: ALWAYS include at least 1-2 artist references in caption (unless user already provided one)
