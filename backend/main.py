...
async def acestep_genre_presets():
    ...
    Returns empty genres dict - frontend uses GENRE_PRESETS from code instead.
    This avoids empty categories in UI dropdown.
    """
    return JSONResponse(content={"version": 1, "genres": {}})
